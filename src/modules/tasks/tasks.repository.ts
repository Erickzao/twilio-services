...
export class TasksRepository {
  ...
  async findAssignedByCustomerContact(
  ...
  async setGreetingSent(
    ...
    await this.client.execute(
      query,
      [greetingSentAt, null, null, now, types.Uuid.fromString(id)],
      {
        prepare: true,
      },
    );
